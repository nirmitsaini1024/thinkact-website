  ...
  const approachData = [
    {
      title: 'Think',
      description:
        'Our AI agents understand document context, relationships, and implications—not just text extraction. They comprehend industry-specific terminology and regulatory requirements, making connections that would otherwise require human expertise.',
      icon: '🧠',
    ...
    },
    {
      title: 'Plan',
      description:
        'Based on this understanding, our system creates dynamic processing workflows, adapting in real-time to document variations, quality issues, and changing requirements. It prioritizes critical information and identifies potential compliance risks before they become problems.',
      icon: '📋',
    ...
    },
    {
      title: 'Execute',
      description:
        'ThinkAct AI autonomously carries out complex document tasks with minimal human intervention—from classification and data extraction to verification and compliance checking. The system continuously learns from each interaction, becoming more efficient and accurate over time.',
      icon: '⚡',
  ...
  const valuesData = [
    {
      ...
      description:
        "We push the boundaries of what's possible in AI while maintaining unwavering standards for security, accuracy, and compliance.",
      icon: '🚀',
    },
    {
      title: 'Customer-Centric Solutions',
      description:
        'We design our technology around real-world challenges, measuring our success by the tangible outcomes we deliver for our clients.',
      icon: '🎯',
    },
    {
      title: 'Responsible AI',
      description:
        'We develop our technology with strong ethical principles, ensuring transparency, fairness, and accountability in all our AI systems.',
      icon: '⚖️',
    },
    {
      title: 'Security by Design',
      description:
        "We build security into every aspect of our platform, protecting our clients' most sensitive information at every step.",
      icon: '🔒',
    },
    {
      title: 'Continuous Improvement',
      description:
        "We're never satisfied with the status quo, constantly refining our technology to deliver better results for our clients.",
      icon: '🔄',
    },
  ];
  ...
  return (
    <>
      <div className="overflow-hidden">
        ...
        <section
          ref={heroRef}
          className="relative py-40 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100"
        >
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto font-medium">
              Revolutionizing document processing through agentic AI,
              transforming how highly regulated industries handle their most
              critical workflows
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100">
              <p className="text-xl text-gray-700 leading-relaxed mb-6">
                ThinkAct AI was founded in 2024 with a singular vision to
                revolutionize document processing through agentic AI. We were
                born at the intersection of artificial intelligence and
                industry-specific challenges when our founders recognized that
                traditional document processing systems were failing to meet
                complex needs of highly regulated industries.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                A team of AI researchers, document security experts, and
                industry veterans came together to create a solution that could
                think, plan, and execute autonomously—moving beyond static rules
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="group">
                <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-gray-100">
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed">
                    To empower organizations to unlock the full potential of
                    their document workflows through intelligent automation that
                    understands context, adapts to changing conditions, and
                    continuously improves over time. We're committed to reducing
                    processing time, eliminating errors, and enhancing security
              ...
              <div className="group">
                <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-gray-100">
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed">
                    We envision a future where document processing is no longer
                    a bottleneck but a strategic advantage. A world where
                    mortgage applications are processed in days not months,
                    where airport security credentials are verified instantly
                    with uncompromising accuracy, and where compliance is built
                    into every step of the document lifecycle.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {approachData.map((approach, index) => (
                <div key={index} className="group h-full">
                  <div className="relative overflow-hidden rounded-3xl bg-white p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-gray-100 h-full flex flex-col">
                    <div
                      className={`absolute inset-0 bg-gradient-to-r ${approach.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500`}
                    ></div>
              ...
              <div className="group h-full md:col-span-2">
                <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-gray-100 h-full flex flex-col">
                  <div className="flex flex-col items-center text-center flex-grow">
                    ...
                    <p className="text-gray-600 leading-relaxed flex-grow">
                      Manjeet is visionary founder of ThinkAct AI leading in
                      delivering transformative technology solutions by
                      leveraging AI models and agents that empower enterprises
                      to innovate, scale, and succeed. With over two decades of
                      experience in the technology sector, he specializes in
                      cloud-native SaaS products, blockchain, and cryptography
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto opacity-90">
              Join our journey and discover how ThinkAct AI can revolutionize
              your document processing with intelligent automation that truly
