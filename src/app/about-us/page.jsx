              ...
              <div className="group h-full md:col-span-3">
                <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-gray-100 h-full flex flex-col">
                  <div className="flex flex-col items-center text-center flex-grow">
                    ...
                    <p className="text-gray-600 leading-relaxed flex-grow">
                      Christopher Gallo is a results-driven sales executive with a proven track record of originating and managing billions of dollars in sales, particularly within the mortgage and financial services sector. Over the course of more than 20 years, he has consistently built and led high-performing teams, streamlined complex processes, and delivered exceptional value to clients and business partners. Known for his strategic mindset and commitment to operational excellence, Christopher has earned a reputation as a trusted advisor and forward-thinking leader in sales. His success is rooted in a deep understanding of customer needs, a relentless pursuit of efficiency, and a passion for using technology to drive scalable growth. Based in New Jersey, he balances his career with a strong commitment to family and personal well-being                   
                    </p>
                  </div>
                </div>
              </div>
